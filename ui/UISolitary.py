...
class UISolitary:
    ...
    def setup_styles(self):
        ...
        title_font = font.Font(family="Bebas Neue", size=26, weight="bold")
        button_font = font.Font(family="Bebas Neue", size=16, weight="bold")
        small_button_font = font.Font(family="Bebas Neue", size=12, weight="bold")
        ...
        self.style.configure("TLabel", font=title_font, background=MAIN_COLOR, foreground=SECONDARY_COLOR)
        self.style.configure("TButton", font=button_font, borderwidth=0)
        ...
        self.style.configure("Small.Secondary.TButton", font=small_button_font, BACKGROUND_COLOR=MAIN_COLOR, foreground=SECONDARY_COLOR)
    ...
    def on_build_deck(self):
        ...
        self.ui_deck.canvas.place(relx=0.5, rely=0.46, anchor="center")
        self.ui_deck.draw()
    ...
    def on_validate_deck(self):
        ...
        self.toggle_deck_button.place(relx=0.75, rely=0.25, anchor="center")
    ...
    def draw_message_box(self):
        ...
        self.import_file_button = ttk.Button(self.messages_container,
                                                ...
                                                cursor="hand2",
                                                style="Secondary.TButton")
        self.import_file_button.grid(row=0, column=2)
